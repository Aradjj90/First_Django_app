# Generated by Django 4.2.1 on 2023-06-24 10:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ava', models.BinaryField(blank=True, editable=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(max_length=255, unique=True, verbose_name='URL')),
                ('content', models.TextField(blank=True, verbose_name='Контакт')),
                ...
                ('cat', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='animal.category', verbose_name='Категорії')),
